...
#ifndef STUKA_LP_SLACK_PRECONDITIONER_H
#define STUKA_LP_SLACK_PRECONDITIONER_H

#include "base_preconditioner.h"

namespace stuka { namespace LP {
  class SlackPreconditioner : public BasePreconditioner {
  public:
    SlackPreconditioner(const std::shared_ptr<BaseLinearProgram> &next);
  ...
  private:
    ...
    std::shared_ptr<Eigen::SparseMatrix<double>> A_slack_;
  };
}}

#endif //STUKA_LP_SLACK_PRECONDITIONER_H
